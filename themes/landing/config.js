const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_1_URL: 'https://github.com/yzykevin',

  LANDING_HEADER_BUTTON_2_TITLE: '作者博客',
  LANDING_HEADER_BUTTON_2_URL: 'https://blog.sostrt.com/',

  // 首页大图英雄板块
  LANDING_HERO_TITLE_1: 'SOSTRT',
  LANDING_HERO_P_1: 'Stand, Omni-Studio, Truth, Realization, Technology',
  LANDING_HERO_BUTTON_1_TEXT: '进入博客',
  LANDING_HERO_BUTTON_1_LINK: 'https://blog.sostrt.com/',
  ...
  // 特性介绍
  LANDING_FEATURES_HEADER_1: 'Idea',
  ...
  LANDING_FEATURES_HEADER_1_P: "立场，全相工作室，真实，实现，科技",
  ...
  // 感言
  LANDING_TESTIMONIALS_HEADER: 'Make it simple | 简化',
  LANDING_TESTIMONIALS_P: 'Realize it! Think from the roots. | 实现！从本质思考。',
